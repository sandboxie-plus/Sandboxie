...
__inline size_t qHash( const QVariant & var )
{
    ...
    switch ( var.typeId() )
    {
        case QMetaType::Int:        return qHash( var.toInt() );
        case QMetaType::UInt:       return qHash( var.toUInt() );
        case QMetaType::Bool:       return qHash( var.toUInt() );
        case QMetaType::Double:     return qHash( var.toUInt() );
        case QMetaType::LongLong:   return qHash( var.toLongLong() );
        case QMetaType::ULongLong:  return qHash( var.toULongLong() );
        case QMetaType::QString:    return qHash( var.toString() );
        case QMetaType::QChar:      return qHash( var.toChar() );
        case QMetaType::QStringList:return qHash( var.toString() );
        case QMetaType::QByteArray: return qHash( var.toByteArray() );
        default:                    break;
    }

    // fall back: try string conversion
