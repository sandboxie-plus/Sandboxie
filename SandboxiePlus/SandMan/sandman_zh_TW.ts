...
處理程序相符級別的優先順序高於特異度，它描述了一條規則如何適用於一個給定的處理程序。按處理程序名稱或組應用的規則具有最高的相符級別，其次是否定式相符(即適用於相符除給定處理程序以外的所有處理程序的規則)，而最低的相符級別是全域相符，即適用於任何處理程序的規則。</translation>
    ...
    <message>
        ...
        <translation type="vanished">允許使用嵌套作業物件 (job object) (適用於 Windows 8 及更高版本)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">處理程序被拒絕存取非沙箱處理程序記憶體時發出問題代碼 2111</translation>
    </message>
    <message>
...
請注意，這些值為目前使用者針對所有沙箱儲存。</translation>
    ...
    <message>
        ...
        <translation type="vanished">彌補失去的保護，請參考「限制」設定組中的降低權限部分。</translation>
    </message>
    <message>
